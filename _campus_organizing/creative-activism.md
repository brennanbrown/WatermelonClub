...
**Materials:**
- Paper (8.5" x 11" regular printer paper)
- Pen/markers
- Scissors
...
**Video tutorial:** [How to Make an 8-Page Zine](https://www.youtube.com/watch?v=Gx_c3x7sMH4)

### Content Ideas

**Palestine 101 Zine** - Basic facts, key dates, myth-busting, resources. Keep it visual, use infographics from [Visualizing Palestine](https://visualizingpalestine.org/).
...
**Space:** Someone's living room, campus lounge, café that's cool with it, library study room.

### The Vibe

Not a boring "write your MP" night. Make it an event:
- "Watermelon Social: Crafts for Palestine"
- "Cozy Resistance: Letters & Lattes"
- "Dear Politician: An Aesthetic Experience"

**Invite:** "Bring friends, we'll provide materials, templates, addresses, and moral support."
...
- **MPs:** Use [CJPME templates](https://www.cjpme.org/campaigns) as base, personalize
...
**Sizes:**
- 2"x2" - cheap, versatile
- 3"x3" - more visible
- Laptop size - 3"x5"
- Bumper stickers - 4"x6" or larger

### Where to Stick Them

**Legal-ish:**
- Your own laptop, water bottle, phone case
- Friends' stuff (with permission)
- Community boards (ask first)
- Bathroom stalls (remove toilet ads first?)
- Bus stops (technically vandalism but... 🤷)
...
**OR use Busy Beaver** - [busybeaver.net](https://busybeaver.net/) - Canadian button making service, order in bulk.
...
**Example:** "Wall" of people blocking path, forcing others to walk around (like checkpoints)

**Example:** "Checkpoint" roleplay - ID checks, questions, delays

**Warning:** This can be intense. Debrief afterwards. Respect participants' comfort.

---

## 🎪 Fun Events That Organize
...
**How:**
- Everyone brings clothes they don't want
...
Not just film screenings (see [weekly actions](/campus-organizing/weekly-actions#film-screenings)).
...
## 📸 Social Media Content Creation Parties
...
**Follow:**
- [@handala_cartoon](https://www.instagram.com/handala_cartoon/) - Iconic symbol
...
**Seed bombing** - Wildflower seed balls, "Plant Liberation", distribute

**Photo booth** - Set up at events, props (keffiyeh, signs), share photos

**Painted rocks** - Hide around campus, "Free Palestine", QR codes
...
**Printing:**
- [Sticker Mule](https://www.stickermule.com/) - Stickers
- [Busy Beaver](https://busybeaver.net/) - Buttons (Canada)
- [Overnight Prints](https://www.overnightprints.com/) - Posters
- [Moo](https://www.moo.com/) - Business cards, postcards

**Design:**
- [Canva](https://www.canva.com/) - Free templates
- [Visualizing Palestine](https://visualizingpalestine.org/) - Infographics to share
- [Creative Commons Images](https://search.creativecommons.org/) - Free images

**Learn:**
- [DIY Zine Guide](https://zinepunk.com/) - Everything zines
- [How to Make a Zine (YouTube)](https://www.youtube.com/results?search_query=how+to+make+a+zine)
- [Guerrilla Embroidery](https://www.guerrillaembroidery.org/) - Patches, embroidery

**Inspiration:**
- [@subversivecrossstitch](https://www.instagram.com/subversivecrossstitch/)
...
Creative activism isn't separate from "serious" organizing. It's a strategy.

**Use art for:**
- **Recruitment** - "Come to our craft night" > "Come to our meeting"
...
**Related:** [Weekly Actions](/campus-organizing/weekly-actions), [Campus Organizing Hub](/campus-organizing), [Role Templates](/campus-organizing/roles)

---

**Let's make some art. From the river to the sea, Palestine will be free. 🇵🇸**
